# Set the path to signtool.exe
# iex (iwr -Uri "https://raw.githubusercontent.com/xsscx/windows/refs/heads/main/pwsh/Sign-AllScripts.ps1").Content
$signtoolPath = "C:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x64\signtool.exe"

# Set the parameters for Azure Trusted Signing
$dlibPath = "E:\repos\Microsoft.Trusted.Signing.Client\bin\x64\Azure.CodeSigning.Dlib.dll"
$metadataPath = "C:\AzureTrustedSigning\metadata.json"
...
function Sign-File {
    ...
    & $signtoolPath sign /v /fd SHA256 /td SHA256 /tr $timestampUrl /dlib $dlibPath /dmdf $metadataPath $filePath
    
    if ($LASTEXITCODE -eq 0) {
        Write-Host "Successfully signed: $filePath" -ForegroundColor Green
    } else {
        Write-Host "Failed to sign: $filePath" -ForegroundColor Red
    }
}

# Get all .ps1 files in the current directory and subdirectories
$ps1Files = Get-ChildItem -Recurse -Filter *.ps1

# Loop through each .ps1 file and sign it
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBowZJmcB0g7a3+
# H+Qrd26j+xmK/nF2faa4x+mNFFFQX6CCIqIwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIJxYlYo9WHRhT+wgNmvAwNj9UReM3wLt
# lS7UPL/Xk4XMMA0GCSqGSIb3DQEBAQUABIIBgA5qgvfcH5LNE8Z3qrpI44VSD9cp
# 2PmKzfdOhDM6iL18C7JCASkyNJoC2wQdzIQU5Fb1ORSAEsCcL/KLW9FOtTUfs0Yw
# Tn0HEcbNMulxo1Xhqs+yFCykwdkZnax4W+eQ1P1Z0z3lJYA2udgwAb9lJsGV+RNv
# yCR85IT3O124EZDu55OUCX9frMmfFOx7T71f4+80u8NYM9tddOmxXfIVx8FgSn8Y
# 8e1EYTkZIHPNxyZSvrkzPE4KsTPUognSK1CkctsN/euzFBqMftC3a+hSoFhVmBCZ
# FthHhb28jH8CWSlm4KCovuWSlB8PQRmmVQAJHmr2bGDCtFj62gC+zOvDSHSDG/5a
# QLLgWAMUnMIMaT1i3A5WPGqdsWk4m04vpoK68rymWQf10+oRGhVtY0Oo59V667h/
# qkUBBShvm5PEtI7WSRTxrXQJu+kYmxXifiDK2IZXFwnBKAnvqXbOo+LXUeS0XJb5
# 2p6cR6z0ZdTwW8phSnIJX1eFY0fkJ8oaUaBlk6GCFzowghc2BgorBgEEAYI3AwMB
...
# AQUABCAYnAobkxU4Xfl+Qoqv8BeHTaWYjvJFX8XmtDV54LIiLQIRANiwl7Fqvlok
# vA8IDatX9UIYDzIwMjQxMDMwMjA0OTI2WqCCEwMwgga8MIIEpKADAgECAhALrma8
...
# DxcNMjQxMDMwMjA0OTI2WjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTb04XuYtvS
# Pnvk9nFIUIck1YZbRTAvBgkqhkiG9w0BCQQxIgQgwWtJZJJ7HC+USmbYR4dq7YEu
# MhfwVIxdirPM7WV9RjkwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgdnafqPJjLx9D
# CzojMK7WVnX+13PbBdZluQWTmEOPmtswDQYJKoZIhvcNAQEBBQAEggIAJut265A1
# 0GWyjm0VGoFGRnZpxp8M0ZLa5IrBww38PmV5T0q1VMBgUQwVTAW3IB0mhaR3Byq+
# R3awKhpCmukReVlNMWSh/FRe4cm7K44Tv5wfx37uA+vvf8KYiPdzFzfBqrrpdyZN
# K7lkO42C2/aRo0NbPEI/OYmBKBFaHvn96deXsikx0J2ZwoqncL7WrPZ5Ukf94o/E
# 05/4O6XISmyPSlOT6HYTpGfWXNFJQ7QXPO8d+D4SocTqne5cQ5Lb5Ou1sMND6o3a
# nvzYGGTCfVefBttHgBgWr75VpI/BMIQB2wj947F7jWcLS+w5rhtW7rS4Dv9iLL3x
# scMRGzhWS4nflE6m731OnZmwGNmLrhoRuN1c6TprK+QuX0NlsjnjR20ULnnF42xN
# G5FMCp+PGRijYnrNIsq3kvxqYCAQizeQYkvCkEoAv2+RPD7AxHabs0Rl/vL7KWkO
# 8YJY6/0UlxqImBSnlHghUPLrRBgKAEyui6YPNhdyYm0lSpxsXVW/rpLpXcl1ud3h
# aF7wjHvfaYkGoxylPmXcpnzImmogi3Z1qCZ83Flu5V499Cjr/DleJEiB7VSYfMY/
# RvuX0eWwmXLFDos1LhkDwSQUn3eT0GNlno9zREo0aBK1ssI86bOYzmEaMyMWy00P
# JhIFJ6TG5sTdzZLwPvuGzABksnnqvuAfZO0=
